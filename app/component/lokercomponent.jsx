...
const Lokercomponent = ({visible}) => {
    return (
        <div className={`${visible} scroll-smooth md:scroll-auto container mx-auto mt-5`}>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <div className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Loker</div>
                            </div>
                        </li>
                    </ol>
                </nav>
